...
const translations = {
  tr: {
    ...
    // Gemini
    geminiPlaceholder: "Gemini'ye sorun...",
    geminiSend: 'Gönder',
    geminiLoading: 'Gemini yanıtlıyor...',
  ...
  en: {
    ...
    geminiSend: 'Send',
    geminiLoading: 'Gemini is responding...',
    geminiReset: 'Reset Chat',
    geminiResetMsg: 'Are you sure you want to delete all message history?',
    geminiCancel: 'Cancel',
    geminiConfirm: 'Reset',
